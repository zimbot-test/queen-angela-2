...
if (Config.WORKTYPE == 'private') {
    ...
    Cyber.addCommand({ pattern: 'mediafire ?(.*)', fromMe: true, desc: YTV_DESC,  deleteCommand: false}, async (message, match) => {
    ...
    Cyber.addCommand({ pattern: 'mediafire ?(.*)', fromMe: false, desc: YTV_DESC}, async (message, match) => {
